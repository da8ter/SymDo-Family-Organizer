...
| 3 | **MS Raw-Erhalt** für Reminder, Status, Body-Typ | Status-Treue (IN-PROGRESS) bei Fremd-Edits | ✅ umgesetzt (v2.9) |
| 4 | **MS lokale Zeitzone** für due/reminder (B2) | korrekte Datumsanzeige in MS To Do | ✅ umgesetzt (v2.6) |
| 5 | **CalDAV RRULE** schreiben/lesen | eigene Wiederholungen serverseitig sichtbar (inkl. stündlich) | ✅ umgesetzt (v2.9) |
| 6 | **CalDAV VALUE=DATE** (D3) | echte Ganztags-Aufgaben erzeugen | ✅ umgesetzt (v2.9) |
| 7 | Google-Erhalt-Garantien testen + dokumentieren | lokale Felder gegen Regression abgesichert | ✅ umgesetzt (v2.9) |
