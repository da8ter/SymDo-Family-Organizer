...
trait SuggestionEngine
{
    private function GetDefaultSuggestions(): array
    {
        return [
            ...
            // Marken-Erweiterung 2026-07: gängige Marken → Regal-Kategorie
            ['name' => 'Kærgården', 'category' => 'Milch & Käse'],
            ['name' => 'Kärgarden', 'category' => 'Milch & Käse'],
            ['name' => 'Kaergarden', 'category' => 'Milch & Käse'],
            ['name' => 'Rama', 'category' => 'Milch & Käse'],
            ['name' => 'Lätta', 'category' => 'Milch & Käse'],
            ['name' => 'Meggle', 'category' => 'Milch & Käse'],
            ['name' => 'Landliebe', 'category' => 'Milch & Käse'],
            ['name' => 'Weihenstephan', 'category' => 'Milch & Käse'],
            ['name' => 'Zott', 'category' => 'Milch & Käse'],
            ['name' => 'Ehrmann', 'category' => 'Milch & Käse'],
            ['name' => 'Almette', 'category' => 'Milch & Käse'],
            ['name' => 'Exquisa', 'category' => 'Milch & Käse'],
            ['name' => 'Milram', 'category' => 'Milch & Käse'],
            ['name' => 'Danone', 'category' => 'Milch & Käse'],
            ['name' => 'Actimel', 'category' => 'Milch & Käse'],
            ['name' => 'Philadelphia', 'category' => 'Milch & Käse'],
            ['name' => 'Milka', 'category' => 'Snacks & Süßes'],
            ['name' => 'Lindt', 'category' => 'Snacks & Süßes'],
            ['name' => 'Ritter Sport', 'category' => 'Snacks & Süßes'],
            ['name' => 'Haribo', 'category' => 'Snacks & Süßes'],
            ['name' => 'Katjes', 'category' => 'Snacks & Süßes'],
            ['name' => 'Leibniz', 'category' => 'Snacks & Süßes'],
            ['name' => 'Bahlsen', 'category' => 'Snacks & Süßes'],
            ['name' => 'Oreo', 'category' => 'Snacks & Süßes'],
            ['name' => 'Snickers', 'category' => 'Snacks & Süßes'],
            ['name' => 'Twix', 'category' => 'Snacks & Süßes'],
            ['name' => 'Duplo', 'category' => 'Snacks & Süßes'],
            ['name' => 'Kinderriegel', 'category' => 'Snacks & Süßes'],
            ...
            ['name' => 'Jacobs Krönung', 'category' => 'Getränke'],
            ['name' => 'Dallmayr', 'category' => 'Getränke'],
            ['name' => 'Iglo', 'category' => 'Tiefkühl'],
            ['name' => 'Frosta', 'category' => 'Tiefkühl'],
            ['name' => 'Ben & Jerry’s', 'category' => 'Tiefkühl'],
            ['name' => 'Mövenpick Eis', 'category' => 'Tiefkühl'],
            ['name' => 'Barilla', 'category' => 'Konserven & Trocken'],
            ['name' => 'Miracoli', 'category' => 'Konserven & Trocken'],
            ['name' => 'Knorr', 'category' => 'Konserven & Trocken'],
            ['name' => 'Maggi', 'category' => 'Konserven & Trocken'],
            ['name' => 'Heinz', 'category' => 'Konserven & Trocken'],
            ['name' => 'Kühne', 'category' => 'Konserven & Trocken'],
            ['name' => 'Thomy', 'category' => 'Konserven & Trocken'],
            ['name' => 'Mondamin', 'category' => 'Konserven & Trocken'],
            ['name' => 'Mirácoli', 'category' => 'Konserven & Trocken'],
            ['name' => 'Persil', 'category' => 'Haushalt & Reinigung'],
            ['name' => 'Ariel', 'category' => 'Haushalt & Reinigung'],
            ['name' => 'Lenor', 'category' => 'Haushalt & Reinigung'],
            ['name' => 'Somat', 'category' => 'Haushalt & Reinigung'],
            ['name' => 'Finish', 'category' => 'Haushalt & Reinigung'],
            ['name' => 'Pril', 'category' => 'Haushalt & Reinigung'],
            ['name' => 'Frosch', 'category' => 'Haushalt & Reinigung'],
            ['name' => 'Sagrotan', 'category' => 'Haushalt & Reinigung'],
            ['name' => 'Zewa', 'category' => 'Haushalt & Reinigung'],
            ['name' => 'Nivea', 'category' => 'Hygiene & Pflege'],
            ['name' => 'Dove', 'category' => 'Hygiene & Pflege'],
            ['name' => 'Colgate', 'category' => 'Hygiene & Pflege'],
            ['name' => 'Elmex', 'category' => 'Hygiene & Pflege'],
            ['name' => 'Oral-B', 'category' => 'Hygiene & Pflege'],
            ['name' => 'blend-a-med', 'category' => 'Hygiene & Pflege'],
            ['name' => 'Tempo', 'category' => 'Hygiene & Pflege'],
            ['name' => 'Pampers', 'category' => 'Baby & Tier'],
            ['name' => 'HiPP', 'category' => 'Baby & Tier'],
            ['name' => 'Alete', 'category' => 'Baby & Tier'],
            ['name' => 'Whiskas', 'category' => 'Baby & Tier'],
            ['name' => 'Pedigree', 'category' => 'Baby & Tier'],
            ['name' => 'Sheba', 'category' => 'Baby & Tier'],
            ['name' => 'Frolic', 'category' => 'Baby & Tier'],
        ];
    }
