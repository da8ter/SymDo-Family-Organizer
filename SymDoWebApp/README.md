...
- **Prüfungen** — die Klassenarbeiten aus WebUntis stehen als Block über den Hausaufgaben, im Kopf „Nächste Prüfung", je Prüfung eine **Zeitleiste** vom Lernstart bis zum Prüfungstag („6 Tag(e) bis Prüfung · 25%", Farbe des Fachs; der Lernstart liegt so viele Tage vorher wie die Lern-Erinnerung, ohne sie eine Woche), entfallene durchgestrichen ohne Leiste, und sind im Tagesbalken und im Wochenraster markiert: eigenes Zeichen, heller Rahmen, Titel. Eine geänderte Prüfung bleibt Prüfung, nicht Vertretung. Die Lern-Erinnerung vor einer Prüfung ist eine gewöhnliche Hausaufgabe mit der Quelle „Prüfung (UNTIS)"
