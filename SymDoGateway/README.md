...
- **KI-Analyse** — Foto oder PDF wird zu Aufgaben-, Termin- und Notiz-Vorschlägen; jeder Fund lässt sich zwischen Aufgabe, Termin und Notiz umstimmen und wird beim Übernehmen nacheinander im vorausgefüllten Dialog bestätigt (Ordner, Kalender und Zeiten anpassbar). Auf Wunsch werden auch E-Mails ausgewertet (IMAP-Abruf oder Weiterleitung)
