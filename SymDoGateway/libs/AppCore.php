...
trait AppCore
{
    ...
    /**
     * Gibt es überhaupt Klassenseiten? Eingeschaltet, gespiegelt, und mindestens
     * eine Seite eingetragen oder gefunden.
     */
    private function EdumapsVorhanden(): bool
    {
        if (!$this->EduIsEnabled() || !(bool)$this->EduProp('EduToNotes', false)) {
            return false;
        }
        return $this->EduSeiten() !== [] || $this->EduStoreRead()['folders'] !== [];
    }
