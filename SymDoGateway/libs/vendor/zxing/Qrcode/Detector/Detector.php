...
namespace da8ter\SymDo\Zxing\Qrcode\Detector;

use da8ter\SymDo\Zxing\Common\BitMatrix;
use da8ter\SymDo\Zxing\Common\Detector\MathUtils;
use da8ter\SymDo\Zxing\Common\DetectorResult;
use da8ter\SymDo\Zxing\Common\GridSampler;
use da8ter\SymDo\Zxing\Common\PerspectiveTransform;
use da8ter\SymDo\Zxing\DecodeHintType;
use da8ter\SymDo\Zxing\FormatException;
use da8ter\SymDo\Zxing\NotFoundException;
use da8ter\SymDo\Zxing\Qrcode\Decoder\Version;
use da8ter\SymDo\Zxing\ResultPoint;
use da8ter\SymDo\Zxing\ResultPointCallback;
...
class Detector
{
	...
	final protected function processFinderPatternInfo(FinderPatternInfo $info): \da8ter\SymDo\Zxing\Common\DetectorResult
	{
		...
		$provisionalVersion = \da8ter\SymDo\Zxing\Qrcode\Decoder\Version::getProvisionalVersionForDimension($dimension);
	...
	private static function sampleGrid(
		...
		int $dimension
	): \da8ter\SymDo\Zxing\Common\BitMatrix {
