...
namespace da8ter\SymDo\Zxing\Qrcode\Decoder;

use da8ter\SymDo\Zxing\ChecksumException;
use da8ter\SymDo\Zxing\Common\BitMatrix;
use da8ter\SymDo\Zxing\Common\DecoderResult;
use da8ter\SymDo\Zxing\Common\Reedsolomon\GenericGF;
use da8ter\SymDo\Zxing\Common\Reedsolomon\ReedSolomonDecoder;
use da8ter\SymDo\Zxing\Common\Reedsolomon\ReedSolomonException;
...
final class Decoder
{
	private readonly \da8ter\SymDo\Zxing\Common\Reedsolomon\ReedSolomonDecoder $rsDecoder;
	 ...
	 * @throws ChecksumException if error correction fails
	 */
	public function decodeBits(\da8ter\SymDo\Zxing\Common\BitMatrix $bits, $hints = null): string|DecoderResult
	{
	...
	private function decodeParser(\da8ter\SymDo\Zxing\Qrcode\Decoder\BitMatrixParser $parser, ?array $hints = null): DecoderResult
	{
