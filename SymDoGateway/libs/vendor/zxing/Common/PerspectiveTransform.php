...
final class PerspectiveTransform
{
	...
	public function buildAdjoint(): \da8ter\SymDo\Zxing\Common\PerspectiveTransform
	{
	...
	public static function squareToQuadrilateral(
		...
		float $x3,
		float $y3
	): \da8ter\SymDo\Zxing\Common\PerspectiveTransform {
		$dx3 = $x0 - $x1 + $x2 - $x3;
		$dy3 = $y0 - $y1 + $y2 - $y3;
		if ($dx3 == 0.0 && $dy3 == 0.0) {
			// Affine
	...
	public function times(self $other): \da8ter\SymDo\Zxing\Common\PerspectiveTransform
	{
		return new PerspectiveTransform(
